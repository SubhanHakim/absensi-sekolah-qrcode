...
<x-app-layout>
                                        ...
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            <td class="py-3 px-4">
                                                @if($leave->attachment_path)
                                                    <a href="{{ Storage::url($leave->attachment_path) }}" target="_blank" class="text-blue-600 hover:underline">
                                                        Lihat
                                                    </a>
                                                @else
                                                    -
                                            ...
                                            <td class="py-3 px-4">
                                                @if($leave->status == 'pending')
                                                    <button onclick="openModal('{{ $leave->id }}')" class="bg-blue-600 hover:bg-blue-700 text-white py-1 px-3 rounded text-xs">
                                                        Proses
                                                    </button>
                                                @else
        ...
        <div class="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <form id="approvalForm" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="status" id="status" class="w-full border-gray-300 focus:border-indigo-500 rounded-md shadow-sm">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" id="notes" rows="3" class="w-full border-gray-300 focus:border-indigo-500 rounded-md shadow-sm"></textarea>
                </div>
    ...
    <script>
        function openModal(id) {
            document.getElementById('approvalForm').action = "{{ url('dashboard/guru/leave-requests') }}/" + id;
