<x-app-layout>
    ...
    <div class="min-h-[80vh] flex items-center justify-center bg-gray-100 py-8">
        <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            <h3 class="text-2xl font-bold mb-2 text-blue-700 text-center">Tambah Guru</h3>
            <p class="text-gray-500 mb-6 text-center">Silakan isi data guru dengan benar.</p>
            ...
            <form action="{{ route('gurus.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" class="w-full border rounded px-3 py-2 focus:ring focus:border-blue-400" required>
                </div>
                <div class="mb-4">
                    <label class="block mb-1 font-medium text-gray-700">NIP</label>
                    <input type="text" name="nip" class="w-full border rounded px-3 py-2 focus:ring focus:border-blue-400" required>
                </div>
                <div class="mb-4">
                    <label class="block mb-1 font-medium text-gray-700">Email</label>
                    <input type="email" name="email" class="w-full border rounded px-3 py-2 focus:ring focus:border-blue-400" required>
                </div>
                <div class="mb-6">
                    <label class="block mb-1 font-medium text-gray-700">Mapel</label>
                    <input type="text" name="mapel" class="w-full border rounded px-3 py-2 focus:ring focus:border-blue-400">
                </div>
