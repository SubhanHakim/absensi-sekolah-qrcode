                            ...
                            <tr class="hover:bg-blue-50 even:bg-gray-50 transition">
                                ...
                                <td class="py-2 px-4 border-b border-gray-200">
                                    ...
                                    @if($totalAbsen > 0)
                                        <div class="space-y-1">
                                            @if($hadirCount > 0)
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-green-100 text-green-700 font-semibold text-xs mr-1 mb-1">
                                            ...
                                            @if($telatCount > 0)
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-yellow-100 text-yellow-700 font-semibold text-xs mr-1 mb-1">
                                            ...
                                            @if($izinCount > 0)
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-blue-100 text-blue-700 font-semibold text-xs mr-1 mb-1">
                                            ...
                                            @if($sakitCount > 0)
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-orange-100 text-orange-700 font-semibold text-xs mr-1 mb-1">
                                            ...
                                            @if($alphaCount > 0)
                                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded bg-red-100 text-red-700 font-semibold text-xs mr-1 mb-1">
